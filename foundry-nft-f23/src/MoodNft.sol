...
contract MoodNft is ERC721 {
    ...
    function flipMood(uint256 tokenId) public {
        if (ownerOf(tokenId) != msg.sender) revert MoodNft__NotNFTOwner();
    ...
    function getTokenMood(uint256 tokenId) public view returns(Mood tokenMood) {
        tokenMood = s_tokenIdToMood[tokenId];
    }
}
