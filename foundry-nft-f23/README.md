...
We get the base64 encoded images from the SVGs got from the course resources in order to save them on chain.

### Happy SVG:

![Happy SVG](./images/dynamicNft/happy.svg)
...
![Sad SVG](./images/dynamicNft/sad.svg)
...
![Example SVG](./images/dynamicNft/example.svg)
